...
#include "CryptRaid/Dialogue.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeDialogue() {}
// Cross Module References
	CRYPTRAID_API UClass* Z_Construct_UClass_UDialogue();
	CRYPTRAID_API UClass* Z_Construct_UClass_UDialogue_NoRegister();
...
// End Cross Module References
	...
	template<> CRYPTRAID_API UClass* StaticClass<UDialogue>()
	{
		return UDialogue::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UDialogue);
	UDialogue::~UDialogue() {}
	struct Z_CompiledInDeferFile_FID_Users_Zac_Documents_OnlineLessons_CryptRaid_Source_CryptRaid_Dialogue_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Zac_Documents_OnlineLessons_CryptRaid_Source_CryptRaid_Dialogue_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogue, UDialogue::StaticClass, TEXT("UDialogue"), &Z_Registration_Info_UClass_UDialogue, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogue), 3034164604U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Zac_Documents_OnlineLessons_CryptRaid_Source_CryptRaid_Dialogue_h_2759082906(TEXT("/Script/CryptRaid"),
		Z_CompiledInDeferFile_FID_Users_Zac_Documents_OnlineLessons_CryptRaid_Source_CryptRaid_Dialogue_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Zac_Documents_OnlineLessons_CryptRaid_Source_CryptRaid_Dialogue_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
